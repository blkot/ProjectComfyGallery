...
| LIB-011–012 | Server-resolved bulk scopes and explicit Any/All multi-model filters | [Frontend UX](design/frontend-ux.md), [API](interfaces/api-and-integrations.md) | Next milestone | Media/review API integration tests, `media-view.test.ts`, Library browser workflow | Implemented; next release lock pending |
| LIB-013–014 | Persistent icon-rail navigation and preview-first media workspaces | [Frontend UX](design/frontend-ux.md) | Next milestone | `app-shell.test.tsx`, media-detail API regression, frontend checks/build, image/video browser verification | Implemented; next release lock pending |
...
| EVAL-020–022 | Context-visible single-media evaluation and durable per-media optional modules | [Evaluation](design/evaluation.md), [Frontend UX](design/frontend-ux.md), [Data model](architecture/data-model.md), [API](interfaces/api-and-integrations.md) | Next milestone | `0009_media_evaluation_modules`, evaluation-context/module API regression, shared frontend control tests, Media Detail browser traversal | Implemented; next release lock pending |
