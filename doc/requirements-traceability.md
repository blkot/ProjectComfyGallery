...
| LIB-010 | Laptop-friendly 2:3 portrait gallery grid | [Frontend UX](design/frontend-ux.md) | post-rc.6 | CSS contract, frontend lint/type/build checks, live MacBook-width browser verification | Implemented; next release lock pending |
